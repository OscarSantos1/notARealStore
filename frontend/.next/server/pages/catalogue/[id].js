...
var ItemCard = __webpack_require__(7520);
...
const getServerSideProps = async (context)=>{
    const responce = await fetch(`http://localhost:5001/api/catalogue/${context.params.id}`);
...
var __webpack_exports__ = __webpack_require__.X(0, [210,676,664,520], () => (__webpack_exec__(18)));

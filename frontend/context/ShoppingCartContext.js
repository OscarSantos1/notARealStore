...
export function ShoppingCartProvider({ children }) {
  ...
  return (
    <ShoppingCartContext.Provider value={{ getItemQuantity, increaseItemQuantity, decreaseItemQuantity, removeFromCart, openCart, closeCart, cartItems, setCartItems, cartQuantity, isOpen, lastAdded, timeOut, stopClose, startClose, fastClose, setFastClose, token, setToken, userName, setUserName }}>
      {children}

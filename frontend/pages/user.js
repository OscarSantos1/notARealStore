...
const user = () => {
  ...
  return (
    <>
      {" "}
      <Head>
        <title>User - NotARealStore</title>
      </Head>
      <div className="relative flex-col justify-end h-screen w-screen pt-32 backdrop-blur-[13px] bg-slate-200/80">
        {token ? (
          <div className="flex justify-center text-sm font-light mb-3">
            <button
              onClick={() => setSection("purchases")}
              className={`${
                section === "purchases" && "bg-black text-white"
              } pb-1 pt-2 px-4 rounded-lg`}
            >
              PURCHASES
            </button>
            <button
              ...
              className={`${
                section === "account" && "bg-black text-white"
              } pb-1 pt-2 px-4 rounded-lg`}
            >
              ACCOUNT
            </button>
        ...
        {section === "purchases" && token ? (
          <div className="absolute bottom-0 top-[172px] flex-col px-6 md:px-28 pt-4 pb-4 space-y-5 w-full overflow-auto">
        ...
        {section === "account" && token ? (
          <div className="flex-col gap-3 px-6 md:px-28 pt-4">
            ...
            <div className="inline-block ml-9 mt-3 font-light underline text-slate-500">
